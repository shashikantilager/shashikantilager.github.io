...
- **Mr. Lukas Briem**, *Master Thesis*,	Towards Resource Efficient Code Generation through Dynamic Early Exits in LLMs, TU Wien, Austria, 2024 - 2025. => ([CCGRID 25](https://arxiv.org/abs/2501.11006)).
- **Ms. Julia Oberauner**, *Master Thesis*, A Runtime Controller for Latency Sensitive Edge Applications, TU Wien, Austria, 2024 - 2025.
- **Mr. Daniel May**, *Master Thesis*, A Hardware-Software Optimization Framework for Energy-aware Inference in Edge AI, TU Wien, Austria, 2024 - 2025 => ([preprint](/assets/pdf/publications/dynasplit_25.pdf)).
- **Matthias Eder**, *Master Thesis*, Data-driven Methods for Climate Change Modelling in Hydrology, TU Wien, Austria, 2024.
- **Mr. Paul. J. Maliakel**, *Master Thesis*,	Achieving Sustainable Federated Edge Analytics by Using Incomplete Data, TU Wien, Austria, 2023. -> ([EdgeSys 24](/assets/pdf/publications/fligan_edgesys_24.pdf)).
...
- **Daniel Hofstätter**, *Semester Project*, Symbolic Representation of Data on Edge, TU Wien, 2023. => ([EuroPar 23](/assets/pdf/publications/europar_symed_23.pdf)). <span style="color:red;">🏆 Young Researcher Award, EuroPar 23</span>.
- **Ms. Meerzhan Kanatbekova**, *Master Thesis*, Symbolic Data Representation of Multi-Media Data on
Edge, TU Wien, May 2022- November 2022. => ([ICSOC 24](/assets/pdf/publications/abbavsm_icsoc24.pdf)).
- **Mr. Mayank Jha**, *Master Thesis*, Statistical Characterization of a Cloud Data Center, TU Wien +
University of L'aquila, Italy, Feb-2022 – November 2022. => ([UCC 23](/assets/pdf/publications/UCC_23_data_center_analysis.pdf)). <span style="color:red;">🏆 Best Paper Award, UCC 23</span>.
- **Mr. Jakob Fahringer**, *Bachelor Thesis*, Decentralized Monitoring in Edge, TU Wien, Feb - October 2022. => ([UCC 22](/assets/pdf/publications/demon_ucc_22.pdf)). 
- **Mr. Shreshth Tuli**, *Semester project*, RL-based Scheduling in Edge-Cloud, UniMelb, Australia, 2020. => ([TMC 22](/assets/pdf/publications/rlscheduling_tmc_22.pdf)).
- **Mr. Nipum Basumati**, *Semester project*, RL-based Scheduling in Edge-Cloud, UniMelb, Australia, 2020.
- **Mr. Tahseen khan**, *Semester project*, Workload Forecasting in Cloud, UniMelb, Australia, 2021. => ([FGCS 22](/assets/pdf/publications/workloadforecast_fgcs_22.pdf), [JNCA 22](/assets/pdf/publications/mlcentricreview_jnca_22.pdf)).
