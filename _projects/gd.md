...
layout: project
title: "GreenDIGIT"
subtitle: "Greener Future DIGItal Research Infrastructures"
description: Sustainability metrics, tools, and practices for European research computing infrastructures and data centers.
importance: -3
status: ongoing
category: research
role: Coordinator
...
team:
  - name: Shashikant Ilager
    role: Coordinator (UvA, from Oct 2025)
    url: /
  - name: Yuri Demchenko
    role: Former Coordinator
    url: http://www.uazone.org/demch/
partners:
  ...
  - name: GÉANT
    url: https://geant.org
objectives:
  - Develop a comprehensive sustainability metrics framework for research computing infrastructures.
  - Build tools for automated environmental impact assessment of digital research workflows.
  - Design and demonstrate carbon-aware scheduling policies across HPC and cloud infrastructures.
  - Engage European research communities to adopt sustainable digital practices.
milestones:
  - date: "Oct 2025"
    text: "Shashikant Ilager takes over as Project Coordinator."
  - date: "May 2026"
    text: "SC4RC Conference, Geneva: presentation on tools and methods for environmental impact assessment."
software:
  - name: GreenDIGIT Project Resources
    url: https://greendigit-project.eu/
    desc: Tools, metrics, and publications from the project.
---
